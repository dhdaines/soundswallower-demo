...
/***/ "../soundswallower/js/model/index.js":
/*!*******************************************!*\
  !*** ../soundswallower/js/model/index.js ***!
  \*******************************************/
/***/ ((module) => {
...
/***/ "../soundswallower/js/soundswallower.js":
/*!**********************************************!*\
  !*** ../soundswallower/js/soundswallower.js ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
if (RUNNING_ON_WEB) {
    ...
    const model_path = __webpack_require__(/*! ./model/index.js */ "../soundswallower/js/model/index.js");
...
function load_model(model_name, model_path, dict_path=null) {
	...
	const fs = __webpack_require__(/*! fs */ "?a49c");
	const path = __webpack_require__(/*! path */ "?c7bb");
...
if (ENVIRONMENT_IS_NODE) {
  if (ENVIRONMENT_IS_WORKER) {
    scriptDirectory = (__webpack_require__(/*! path */ "?c7bb").dirname)(scriptDirectory) + '/';
  } else {
...
requireNodeFS = () => {
  ...
  // created.
  if (!nodePath) {
    fs = __webpack_require__(/*! fs */ "?a49c");
    nodePath = __webpack_require__(/*! path */ "?c7bb");
  }
};
...
var ASM_CONSTS = {
  ...
  function getRandomDevice() {
      ...
      if (ENVIRONMENT_IS_NODE) {
        ...
        try {
          var crypto_module = __webpack_require__(/*! crypto */ "?da93");
...
/** @type {function(...*):?} */
var _ps_process_raw = Module["_ps_process_raw"] = function() {
  return (_ps_process_raw = Module["_ps_process_raw"] = Module["asm"]["ps_process_raw"]).apply(null, arguments);
};
...
async function initialize(config) {
    ssjs = await __webpack_require__(/*! soundswallower */ "../soundswallower/js/soundswallower.js")()
